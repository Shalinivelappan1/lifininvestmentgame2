...
# =====================================================
learning_insights={
"Rate Hike":"Higher rates compress valuations. Defensive positioning helps.",
"Growth Rally":"Risk assets surge in optimistic growth cycles.",
"Crisis":"Risk-off environment. Gold & bonds protect capital.",
"Disinflation":"Cooling inflation supports bonds and balance.",
"Recession":"Defensive allocation usually performs better.",
...
def advanced_metrics(alloc_history,history,smart_history):
    ...
    return round(overtrade,2),round(regret,2),round(timing,2)
...
def commentary(div,risk,overtrade,regret,timing):
    ...
    if regret>15: text+="AI materially outperformed in some regimes. "
...
# PDF
# =====================================================
def pdf_report(file,data,comment):
    doc=SimpleDocTemplate(file)
    elements=[]
    styles=getSampleStyleSheet()
    elements.append(Paragraph("<b>Simulation Report</b>",styles['Title']))
...
if rd>10:
    ...
    st.metric("Benchmark DD",round(dd_b,1))
    ...
    div,risk=behavioural_analysis(st.session_state.alloc_history,hist["Value"])
...
["AI DD",round(dd_ai,1)]
    ...
    pdf_report("report.pdf",data,com)
